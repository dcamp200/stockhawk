        ...
        recyclerView.addOnItemTouchListener(new RecyclerViewItemClickListener(this,
                new RecyclerViewItemClickListener.OnItemClickListener() {
                    ...
                    public void onItemClick(View v, int position) {
                        Log.d(LOG_TAG, "Starting Historical search...");
                        Intent intent = new Intent(MyStocksActivity.this, StockHistoryIntentService.class);
...
//                        intent.putExtra("endDate","2016-06-22");
                    ...
                    new MaterialDialog.Builder(mContext).title(R.string.symbol_search)
                            ...
                            .input(R.string.input_hint, R.string.input_prefill, new MaterialDialog.InputCallback() {
                                ...
                                public void onInput(MaterialDialog dialog, CharSequence input) {
                                    ...
                                    if (c.getCount() != 0) {
                                        Toast toast =
                                                Toast.makeText(MyStocksActivity.this, R.string.alreadySaved,
                                                        Toast.LENGTH_LONG);
    ...
    public void onResume() {
        ...
        LocalBroadcastManager.getInstance(this).registerReceiver(mStockSymbolLookupReceiver,mIntentFilter);
    }

    @Override
    protected void onPause() {
        super.onPause();
        LocalBroadcastManager.getInstance(this).unregisterReceiver(mStockSymbolLookupReceiver);
    }
    ...
    // Broadcast receiver for receiving status updates from the StockIntentService
    private class StockSymbolLookupReceiver extends BroadcastReceiver {
        // Prevents instantiation
        private StockSymbolLookupReceiver() {
        }
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            switch (action) {
                ...
                case Constants.SYMBOL_LOOKUP_FAILURE:
                    ...
                    Log.d(LOG_TAG, "Stock name:" + stock);
                    String message = String.format(mContext.getResources().getString(R.string.stockNotFound),stock);
                    Toast toast = Toast.makeText(MyStocksActivity.this, message, Toast.LENGTH_LONG);
                    toast.setGravity(Gravity.CENTER, Gravity.CENTER, 0);
                    toast.show();
                    break;
                case Constants.SYMBOL_HISTORY_SUCCESS:
                    Log.d(LOG_TAG, "Starting plot activity...");
                    ArrayList<Quote> results = intent.getParcelableArrayListExtra(Constants.SYMBOL_HISTORY_RESULTS);
                    Intent plotIntent = new Intent(MyStocksActivity.this, PlotActivity.class);
                    plotIntent.putExtra(Constants.SYMBOL_HISTORY_RESULTS, results);
                    plotIntent.putExtra("symbol", intent.getStringExtra("symbol"));
                    plotIntent.putExtra("startDate", intent.getStringExtra("startDate"));
                    plotIntent.putExtra("endDate", intent.getStringExtra("endDate"));

                    MyStocksActivity.this.startActivity(plotIntent);
                    break;
                default:
            }
        }
